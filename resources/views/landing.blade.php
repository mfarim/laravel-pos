        ...
        <div class="container">
            <nav class="nav-wrap" aria-label="Main Navigation">
                ...
                <ul class="nav-links" id="main-menu">
                    ...
                    <li class="desktop-hidden"><a href="#demo" id="nav-link-demo" data-i18n="nav_demo">Visual Demo</a></li>
                    <li class="desktop-hidden"><a href="#mobile" id="nav-link-mobile" data-i18n="nav_mobile">Mobile REST API</a></li>
                    <li class="desktop-hidden"><a href="#harga" id="nav-link-harga" data-i18n="nav_pricing">Free Plan</a></li>
                    <li class="desktop-hidden"><a href="#faq" id="nav-link-faq" data-i18n="nav_faq">FAQ</a></li>
                </ul>
                ...
                <div class="nav-actions">
                    ...
                    <button type="button" class="mobile-menu-toggle" id="mobile-menu-btn" aria-label="Toggle navigation menu" aria-expanded="false">
                        <span class="bar"></span>
                        <span class="bar"></span>
                        <span class="bar"></span>
                    </button>
